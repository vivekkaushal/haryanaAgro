...
import { FarmerComponent } from 'app/entities/farmer/farmer.component';
import { FarmerService } from 'app/entities/farmer/farmer.service';
import { Farmer } from 'app/shared/model/farmer.model';

describe('Component Tests', () => {
  describe('Farmer Management Component', () => {
    let comp: FarmerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FarmerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.farmers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
