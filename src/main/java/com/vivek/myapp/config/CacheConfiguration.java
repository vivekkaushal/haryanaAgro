package com.vivek.myapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.vivek.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.vivek.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
